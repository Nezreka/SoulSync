...
- [x] Hero + episode-panel density pass, from Boulder's screenshots of the Dark Matter page:
  ...
  - The billboard capped at 720px while the body ran the full viewport, so the page had two widths and episode actions sat a screen away from their episode. Both now share one measure.
