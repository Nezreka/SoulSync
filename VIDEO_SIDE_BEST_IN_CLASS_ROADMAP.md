...
- [x] Hero + episode-panel density pass, from Boulder's screenshots of the Dark Matter page:
  ...
  - The billboard capped at 720px while the body ran the full viewport, so on an ultrawide monitor an episode's action buttons sat most of a screen away from the episode. The body is now capped too. First attempt centred both halves on a shared measure and Boulder read it as the page having shrunk: a full-bleed backdrop wants its content anchored to the artwork, not floating in the middle of it. Both halves stay left-anchored on the same 56px edge.
  ...
  - The acquisition panel moved from the page basement to the top of the body, where it is actually findable. Commit: this phase.
