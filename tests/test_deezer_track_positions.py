...
def test_maps_track_id_to_real_album_position():
    ...
    pos = resolve_album_track_positions(sess, 'https://api.deezer.com', {'119606'})
...
def test_cache_first_skips_the_network():
    ...
    sess = _Session({})
    pos = resolve_album_track_positions(sess, 'https://api.deezer.com', {'42'}, cache=_Cache())
...
def test_failed_album_is_simply_absent_not_fatal():
    ...
    pos = resolve_album_track_positions(sess, 'https://api.deezer.com', {'1', '2'})
...
def test_zero_position_is_ignored():
    ...
    pos = resolve_album_track_positions(sess, 'https://api.deezer.com', {'1'})
    assert pos == {'7': 4}
