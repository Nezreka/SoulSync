...
const VERSION_MODAL_SECTIONS = [
    {
        ...
        features: [
            ...
            "• write methods (genre / poster / metadata updates) and playlists are unaffected — section-agnostic",
            ...
            "• honest tradeoffs: same artist appearing in multiple sections shows as separate entries (no dedup yet), and write-back updates only one section\'s copy if an artist exists in multiple — revisit if it bites users",
        ],
